...
<link rel="stylesheet" href="css/d8063713469bee5be36129bc9f6220a2.css" data-minify="1" />
...
<!--[if lt IE 9]>
<script type='text/javascript' src='https://xtemos1.r.worldssl.net/basel/wp-content/themes/basel/js/html5.js'></script>
<![endif]-->
...
<link rel="canonical" href="https://demo.xtemos.com/basel/contact-us-2/" />
<link rel='shortlink' href='https://demo.xtemos.com/basel/?p=456' />
<style>@font-face{font-family:"";font-weight:400;font-style:normal}</style>
...
<style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1451151029404 {
	margin-top: -40px!important;
	margin-bottom: 40px!important
}

.vc_custom_1451151413064 {
...
.vc_custom_1440608776919 {
	margin-bottom: 150px!important
}

.vc_custom_1449329667763 {
...
.vc_custom_1438787474201 {
	margin-bottom: 50px!important;
	padding-right: 50px!important
}

.vc_custom_1438787483391 {
	margin-bottom: 50px!important;
	padding-right: 100px!important
}

.vc_custom_1449331484859 {
	margin-bottom: 35px!important
}

.vc_custom_1449332141944 {
	margin-bottom: 30px!important
}

.vc_custom_1449332109988 {
	margin-bottom: 40px!important
}

.vc_custom_1449332119048 {
	margin-bottom: 25px!important
}

.vc_custom_1451151064538 {
											...
											<div class="wpb_column vc_column_container vc_col-sm-6">
												<div class="vc_column-inner vc_custom_1438787483391">
													<div class="wpb_wrapper">
														<div class="title-wrapper  basel-title-color-default basel-title-style-bordered basel-title-size-default text-left vc_custom_1449332141944">
															<div class="liner-continer">
																<span class="left-line"></span>
																<h4 class="title" >
																	<strong>HOW & WHY</strong>
														...
														<div class="vc_row wpb_row vc_row-fluid vc_custom_1474455569533">
															<div class="wpb_column vc_column_container vc_col-sm-6">
																<div class="vc_column-inner ">
																	<div class="wpb_wrapper">
																		<div class=" cursor-pointer basel-info-box2 text-left icon-alignment-left box-style-base color-scheme-dark  with-animation " onclick="window.location.href='http://#'">
																			<div class="box-icon-wrapper">
																				<div class="info-box-icon">
																					<img class="info-icon image-1 " src="https://xtemos2.r.worldssl.net/basel/wp-content/uploads/2016/09/exchange-90x90.png" width="90" height="90" alt="exchange" title="exchange">
																					</div>
																				</div>
																		...
																		<div class="vc_column-inner ">
																			<div class="wpb_wrapper">
																				<div class=" cursor-pointer basel-info-box2 text-left icon-alignment-left box-style-base color-scheme-dark  with-animation " onclick="window.location.href='http://#'">
																					<div class="box-icon-wrapper">
																						<div class="info-box-icon">
																							<img class="info-icon image-1 " src="https://xtemos2.r.worldssl.net/basel/wp-content/uploads/2016/09/information-point-90x90.png" width="90" height="90" alt="information-point" title="information-point">
																							</div>
																						</div>
																						<div class="info-box-content">
																							<div class="info-box-inner">
																...
																<div class="vc_column-inner ">
																	<div class="wpb_wrapper">
																		<div class="wpb_text_column wpb_content_element" >
																			<div class="wpb_wrapper">
																				<p>
																					<span class="vc_icon_element-icon icon-envelope icons" style="float: left; font-size: 38px;"></span>Tel: 877-45-44-33
																					<br /> E-Mail: shop@store.uk
																				</p>
																			</div>
																		</div>
																		<div class="wpb_text_column wpb_content_element" >
																			<div class="wpb_wrapper">
																				<p>
																					<span class="vc_icon_element-icon icon-cursor icons" style="float: left; font-size: 38px;"></span>20 Margaret St, London
																					<br /> Great Britain, 3NM98
																				</p>
																			</div>
																		</div>
																	</div>
																...
																<div class="vc_column-inner ">
																	<div class="wpb_wrapper">
																		<div class="wpb_text_column wpb_content_element" >
																			<div class="wpb_wrapper">
																				<p>
																					<span class="vc_icon_element-icon icon-clock icons" style="float: left; font-size: 38px;"></span>Support forum
																					<br /> for over 24h
																				</p>
																			</div>
																		</div>
																		<div class="wpb_text_column wpb_content_element" >
																			<div class="wpb_wrapper">
																				<p>
																					<span class="vc_icon_element-icon icon-rocket icons" style="float: left; font-size: 38px;"></span>Free standard shipping
																					<br /> on all orders.
																				</p>
																			</div>
																		</div>
														...
														<ul class="social-icons text-left icons-design-colored icons-size-default social-share ">
															<li class="social-facebook">
																<a href="https://www.facebook.com/sharer/sharer.php?u=https://demo.xtemos.com/basel/contact-us-2/" target="_blank" class="">
																	<i class="fa fa-facebook"></i>
																	<span class="basel-social-icon-name">Facebook</span>
																</a>
															</li>
															<li class="social-twitter">
																<a href="http://twitter.com/share?url=https://demo.xtemos.com/basel/contact-us-2/" target="_blank" class="">
																	<i class="fa fa-twitter"></i>
																	<span class="basel-social-icon-name">Twitter</span>
																</a>
															</li>
															<li class="social-google">
																<a href="http://plus.google.com/share?url=https://demo.xtemos.com/basel/contact-us-2/" target="_blank" class="">
																	<i class="fa fa-google-plus"></i>
																	<span class="basel-social-icon-name">Google</span>
																</a>
															</li>
															<li class="social-email">
																<a href="mailto:?subject=Check this https://demo.xtemos.com/basel/contact-us-2/" target="_blank" class="">
																	<i class="fa fa-envelope"></i>
																	<span class="basel-social-icon-name">Email</span>
																</a>
															</li>
															<li class="social-pinterest">
																<a href="images/default.png" target="_blank" class="">
																	<i class="fa fa-pinterest"></i>
																	<span class="basel-social-icon-name">Pinterest</span>
																</a>
															</li>
														</ul>
													</div>
												...
												<div class="vc_column-inner vc_custom_1438787474201">
													<div class="wpb_wrapper">
														...
														<div role="form" class="wpcf7" id="wpcf7-f4-p456-o1" lang="en-US" dir="ltr">
															...
															<form action="home.php" method="post" class="wpcf7-form" novalidate="novalidate">
																...
																<div class="row">
																	...
																	<div class="col-md-12">
																		<p>
																			<label>Your Password (required)</label>
																...
																<p>
																	<input type="submit" value="LOGIN SECURELY" class="wpcf7-form-control wpcf7-submit btn btn-color-primary" />
																</p>
