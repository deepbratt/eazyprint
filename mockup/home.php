					...
					<div class="side-app">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="card card-primary text-center">
									<img class="img-responsive img-effect" src="images/20180206023asd"  style="height:400px;width:100%;background:#CCC;">
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
									<div class="card">
										<img class="img-responsive img-effect" src="images/92e7dc9c-4787-495a-ad2e-88c" style="height:188px;width:100%;background:#CCC;">
									</div>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
									<div class="card">
										<img class="img-responsive img-effect" src="images/Banner-grey-bsda" style="height:188px;width:100%;background:#CCC;">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="card card-primary text-center">
									<img class="img-responsive img-effect" src="images/20180206023asd"  style="height:200px;width:100%;background:#CCC;">
								</div>
							</div>
						</div>
