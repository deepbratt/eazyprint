										 ...
										 <div class="row">
											...
											<div class="col-md-10">
												<?php
													...
													$sub_category = $product_shape_fetch->sub_category_id;
													$get_cat_id = $this->admin_edit_product_shape_m->get_each_subcat($sub_category);
...
?>
		...
		<script>
			...
			/*ajax code start*/
    		 $.ajax({
		        url: '<?php echo base_url();?>admin_edit_product_shape/ajax_fetch_sub_category',
