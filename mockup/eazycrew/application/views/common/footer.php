				...
				<footer class="footer">
					<div class="container">
						...
						<div class="row align-items-center flex-row-reverse" style="margin-top:10px;border-top:1px dotted #CCC;border-bottom:1px dotted #CCC;">
							...
							<div class="col-lg-6 col-sm-12">
								Shipping Partners: <img src="images/fedex.png" style="height:30px;margin:5px;"> <img src="images/dtdc.png" style="height:30px;margin:5px"> <img src="images/delivery.png" style="height:30px;margin:5px">
							</div>
						</div>
