			...
			<div class="page-main">
				...
				<div class="my-3 my-md-5 app-content">
					<div class="side-app">
						...
						<div class="row">
							<div class="col-md-12">
								<form  method="post" class="card" action="<?php echo base_url('admin_add_dealer/add_dealer');?>">
										...
										<?php
											...
											<div class="form-group">
												<div class="row">
												  ...
												  <div class="col-md-10">
													<input type="text" class="form-control" name="trade_licence_number" placeholder="Enter trade licence number">
												  </div>
												</div>
											</div>
