...
class Admin_edit_product_size extends CI_Controller {
	...
	public function edit_product_size()
	{
		...
		$dimension_unit = $this->input->post('dimension');
		$cat_sub_id = $this->input->post('sub_cat_id');
		$records=array('product_size_name'=>$product_size_name,'product_length'=>$dimension_len,'product_width'=>$dimension_wid,'product_height'=>$dimension_height,'dimension_unit'=>$dimension_unit,'sub_category_id'=>$sub_category_name);
