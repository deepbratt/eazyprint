...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Eazyprint | Dealers Login</title>
											   ...
											   <div class="row">
												...
												<div class="form-group">
													<label class="custom-control custom-checkbox">
														...
														<a href="<?php echo base_url('dealers_forgot_password');?>" class="float-right small">I forgot password</a>
													</label>
												</div>
												<div class="form-footer">
													<a href="<?php echo base_url('dealers_dashboard');?>" class="btn btn-primary">Login</a>&nbsp;OR&nbsp;
													<a href="<?php echo base_url('dealers_signup');?>" class="btn btn-primary">Sign Up Here</a>
												</div>
											</form>
										</div>
									</div>
