	...
	<body class="app">
				...
				<div class="container">
					<div class="side-app">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card card-profile "  style="background-image: url(<?php echo base_url('images');?>/background.jpg); background-size:cover;">
									<div class="card-body text-center">
										<img class="card-profile-img" src="<?php echo base_url('images');?>/16.jpg" alt="img">
