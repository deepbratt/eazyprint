										...
										<div class="card-body">
											<div class="form-group ">
													...
													<div class="selectgroup selectgroup-pills">
														...
														<label class="selectgroup-item">
															<input type="checkbox" name="value" value="Angular" class="selectgroup-input" disabled>
															<span class="selectgroup-button text-muted" style="text-decoration: line-through;">2XL</span>
														</label>
														<label class="selectgroup-item">
															<input type="checkbox" name="value" value="Java" class="selectgroup-input" disabled>
															<span class="selectgroup-button text-muted" style="text-decoration: line-through;">3XL</span>
														</label>
													</div>
												</div>
										</div>
