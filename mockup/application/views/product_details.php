...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Title -->
    <title>Eazyprint | 
      <?php echo ucfirst($fetch_prod_data->product_title); ?>
    </title>
    <style>
      .card-body{
                  ...
                  <div id="prozzz_data_hide">
                    <div class="card-body">
                      ...
                      <form method="POST" name="cart_addzz" id="cartz_add" action="<?php echo base_url('product_details/add_to_cart');?>">
                        ...
                        <h1 style="font-size:45px;font-weight:normal">
                        ...
                        <div style="font-size:16px;font-weight:bold;margin-bottom:10px;">
                          <span style="color:red;text-decoration:line-through;font-weight:normal">
                            <i class="fas fa-rupee-sign">
                            </i> 599
                          </span>
                          <span style="color:green;font-weight:normal">40% OFF
                          </span>
                        </div>
					...
					$session_brand_name = $this->session->userdata['product_sidebar']['brand_name'];
					?>
                        <div class="form-group" style="">
                            ...
                            <div class="col-md-6 pull-left">
                              <select name="phone_brand" id="select-beast" class="form-control custom-select" onchange="fetch_brand_namezz(this.value);">
                                ...
                                <option value="<?php echo $each_brand->raw_brand;?>" 
                                        <?php echo (($session_brand_name == $each_brand->raw_brand)?'selected':'')?>>
                          ...
                          <div class="col-md-6 pull-left">
                            ...
                            <select name="phone_model" id="modelzz" class="form-control custom-select">
                              ...
                              <?php
								$fetch_model_name = $this->product_details_m->brand_models($session_brand_name);
								foreach($fetch_model_name AS $each_model){
								?>
                              <option value="<?php echo $each_model->raw_title;?>">
                                <?php echo $each_model->raw_title;?>
                              </option>
                              <?php
}
?>
                      ...
                      <div class="form-group" style="border-bottom:1px dotted #000;padding-bottom:20px;">
                        <div class="row p-2">
                          <div class="col-md-12 pull-left">
                            <label class="form-label" style="text-align:left;margin-left:-8px;">Select Size
                            </label>
                          </div>
                        </div>
...
?>
                          <label class="selectgroup-item" >
                            <input type="radio" name="size" data-error="#errNm3" value="<?php echo $each_raw_size;?>" class="selectgroup-input">
                            <span class="selectgroup-button" style="border:1px solid #000;color:#000;">
                              <?php echo $each_raw_size;?>
                            </span>
                          </label>
                          <?php
}
...
?>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="quantity buttons_added">
                            ...
                            <input type="number" step="1" min="1" max="" name="quantity" value="1" class="input-text qty text" size="4" pattern="" data-error="#errNm4">
        ...
        <div class="row cartstop" style="color:black;">
          <div class="col-md-12" style="margin:0px;padding:0px;">
            <button class="accordion" style="border:1px dotted black;font-size:25px;font-family:samarkan1;background:#f5f5f5;">Product Description
            </button>
            ...
            <button class="accordion" style="border:1px dotted black;font-size:25px;font-family:samarkan1;background:#f5f5f5;">Product Details
            </button>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="table-responsive" style="height:260px;">
                    <table class="table card-table table-vcenter text-nowrap">
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <strong>Best Sellers Rank
                            </strong>
                          </td>
                          <td>#9,823 in Electronics (See top 100)
                            <br>#1883 in Electronics > Accessories >
                            <br> Mobile Accessories > Cases & Covers
                            <br>#5535 in Electronics > Mobiles & Tablets
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <strong>Date First Available
                            </strong>
                          </td>
                          <td>
                            <?php 
                  ...
                  <div class="p-2" style="margin-left:15px;">
                    ...
                    <span>Warranty Details: no warranty
                    </span>
                  </div>
                  <div class="p-2" style="margin-left:15px;">
                    <h4>Feedback
                    </h4>
                    <span>Would you like to tell us about a lower price?
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          <div class="col-md-6" style="float:left;margin:0px;padding:0px;">
            <h3 style="text-align:center;margin-bottom:10px;color:#000;">MUGS PRICING FOR BULK
            </h3>
            <p>&nbsp;
            </p>
            <table class="table table-bordered table-condensed">
              <thead>
                <tr>
                  <th style="color:#000;">Qty
                  </th>
                  <th style="color:#000;">White Mug
                    <br>Price/Piece
                  </th>
                  <th style="color:#000;">Color Mug
                    <br>Price/Piece
                  </th>
                  <th style="color:#000;">Magic Mug
                    <br>Price/Piece
                  </th>
                </tr>
              </thead>
            ...
            <p style="text-align:center;color:#000;">Contact us for bulk orders 
              <a href="<?php echo base_url();?>">Click here
              </a>
            </p>
          </div>
          <div class="col-md-6" style="float:left;margin:0px;padding:0px;text-align:center;">
            <h3 style="text-align:center;margin-bottom:10px;color:#000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MUGS SPECIFICATION
            </h3>
            <p>&nbsp;
            </p>
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          <div class="col-md-4" style="float:left;margin:0px;padding:0px;">
            ...
            <div class="col-md-10" style="float:left;padding:10px;">
              <h4>100% Satisfaction Guaranteed
              </h4>
              <p>We continuously strive hard to achieve your satisfaction as Our Top Priority.
              </p>
            </div>
          </div>
          <div class="col-md-4" style="float:left;margin:0px;padding:0px;">
            ...
            <div class="col-md-10" style="float:left;padding:10px;">
              <h4>Superior Print Quality
              </h4>
              <p>High quality resolution imaging, quality mugs with multi-color printing..
              </p>
            </div>
          </div>
          <div class="col-md-4" style="float:left;margin:0px;padding:0px;">
            ...
            <div class="col-md-10" style="float:left;padding:10px;">
              <h4>Fast Turnaround Times
              </h4>
              <p>Order printing, packing, and handing over to courier in 2-3 business days.
              </p>
            </div>
          </div>
          <div class="clearfix">
		...
		?>
        <h1 style="text-align:center;color:#000;"> Mobile Case Specifications 
        </h1>
        <hr />
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          ...
          <div class="col-md-6" style="float:left;padding:10px;">
            <h4 style="color:#000;font-weight:bold;margin-top:50px;">Permanent Printing
            </h4>
            <p style="color:#000;">You will get your image/design embeded permanently onto the mobile back cover. If the case gets dirty wash it off with soap water and clean it with a soft cloth and reuse the mobile cover as you use it before.
            </p>
          </div>
          <div class="clearfix">
          </div>
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          <div class="col-md-6" style="float:left;padding:10px;">
            <h4 style="color:#000;font-weight:bold;margin-top:50px;">Access to All Standard Buttons and Ports
            </h4>
            <p style="color:#000;">Our mobile back cover/ case has precise cutouts to all standard buttons / ports and snugly fit to the mobile the way you desire it to be.
            </p>
          </div>
          <div class="col-md-6" style="float:left;text-align:center;">
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          ...
          <div class="col-md-6" style="float:left;padding:10px;">
            <h4 style="color:#000;font-weight:bold;margin-top:50px;">Edge to Edge printing
            </h4>
            <p style="color:#000;">100% surface coverage with edge to edge printing on the mobile back cover as exactly as shown here.
            </p>
          </div>
          <div class="clearfix">
          </div>
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          <div class="col-md-6" style="float:left;padding:10px;">
            <h4 style="color:#000;font-weight:bold;margin-top:50px;">Material
            </h4>
            <p style="color:#000;">Made of hard polymer plastic, our mobile back covers offers you an elegant look and will also serve as protection to your mobile from regular scratches & bumps.
            </p>
          </div>
          <div class="col-md-6" style="float:left;text-align:center;">
        ...
        <div class="col-md-12" style="margin:0px;padding:0px;">
          <div class="col-md-4" style="float:left;">
            <h4 style="text-align:center;color:#000;"> T-Shirt Specifications 
            </h4>
            <div class="md-tshirts-block-content" style="border:1px solid #000;">
              <div class="md-tshirts-paragraph" style="padding:15px;">
                <p style="margin-top:30px;">
                  <span style="color:#000;font-weight:bold;">100% Cotton
                  </span>
                </p>
                <ul style="list-style:circle;margin-left:20px;">
                  <li style="color:#000;"> 180-190 gsm (5.9 ounces)
                  </li>
                  <li style="color:#000;"> 100% Ring-spun Cotton
                  </li>
                  <li style="color:#000;"> 2% narrower lycra ribbed neck line, retains its shape after multiple washes
                  </li>
                  <li style="color:#000;"> Available in cool versatile colors
                  </li>
                </ul>
                <p style="color:#000;font-weight:bold;">Amazing Print Quality
                </p> 
          ...
          <div class="col-md-4" style="float:left;">
            <h4 style="text-align:center;color:#000;"> Size Chart 
            </h4>
            <table class="table table-bordered" style="border-color:#000;">
              <thead>
                <tr>
                  <th style="padding:22px;color:#000;border-color:#000;text-align:center;">Size
                  </th>
                  <th style="padding:22px;color:#000;border-color:#000;text-align:center;">Men (in)
                  </th>
                  <th style="padding:22px;color:#000;border-color:#000;text-align:center;">Women (in)
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td style="padding:22px;color:#000;border-color:#000;text-align:center;">S
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">38"
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">34"
                  </td>
                </tr>
                <tr>
                  <td style="padding:22px;color:#000;border-color:#000;text-align:center;">M
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">40"
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">36"
                  </td>
                </tr>
                <tr>
                  <td style="padding:22px;color:#000;border-color:#000;text-align:center;">L
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">42"
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">38"
                  </td>
                </tr>
                <tr>
                  <td style="padding:22px;color:#000;border-color:#000;text-align:center;">XL
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">44"
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">40"
                  </td>
                </tr>
                <tr>
                  <td style="padding:22px;color:#000;border-color:#000;text-align:center;">XXL
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">46"
                  </td>
                  <td style="padding:22px;text-align:center;border-color:#000;">42"
                  </td>
                </tr>
          ...
          <div class="col-md-4" style="float:left;padding:0px;">
            <h4 style="text-align:center;color:#000;"> Benefits You Get 
            </h4>
            <div class="md-tshirts-block-content ps-border-v2" style="border:1px solid #000;padding:20px;">
              <ul class="md-tshirts-upload" style="list-style:circle;margin-left:20px;margin-top:122px;margin-bottom:100px;">
                <li style="color:#000;">Customization Feature to All T-shirts
                </li>
                <li style="color:#000;">Color Fastness Guaranteed
                </li>
                <li style="color:#000;">Compacted Pre-shrunk
                </li>
                <li style="color:#000;">Free Shipping
                </li>
                <li style="color:#000;">High quality printing
                </li>
                <li style="color:#000;">Easy &amp; Secure Payment
                </li>
              </ul>
            </div>
          </div>
		...
		?>
        <h1 class="page-title" style="color:black;text-align:left;font-size:45px;font-family:samarkan1;"> Similar Products 
        </h1>
        <p>&nbsp;
        </p>
                      ...
                      <a href="<?php echo base_url("product_details");?>/<?php echo $each_similar_prod->product_id;?>">
                        ...
                        <div class="card item-card" style="margin-top:-22px;">
                          ...
                          <p style="font-family:arial;text-align:center;"> 
                            ...
                            <span style="color:#000;font-weight:bold;font-size:18px;padding-left:10px;"> 
                              <i class="fas fa-rupee-sign">
                              </i> 
                              <?php echo $each_similar_prod->product_retail_price;?> /- 
                            </span> 
                          </p>
