							...
							<div class="col-lg-9">
								...
								?>
									<div class="col-lg-4" style="border-radius:5px !important;">
										<img class="" alt="" src="<?php echo base_url();?>images/6598a941-fc31-4291-baef-4a984763492b.jpg" data-holder-rendered="true" style="border-radius:5px 5px 0px 0px !important;border:1px solid #CCC !important;">
										<div class="card item-card">
												<div class="cardtitle" style="text-align:center;padding-top:15px;">
													<a href="#" style="text-align:center;font-size:16px;">Moto G5 Plus backcover</a>
												</div>
