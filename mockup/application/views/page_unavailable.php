...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Title -->
    <title>Eazyprint | Page Not Found
    </title>
    <?php
...
?>
          ...
          <div class="col-md-12 register_col_height">
            <span id="j_id0:j_id30">
              <style>
                ...
                .page_found:last-child{
                  background:url('../images/seller_images/red-circle-exclamation-mark-icon-warning-sign-vector-13227846.jpg') center top no-repeat;
                }
              </style>
            </span>
          </div>
    ...
    <div class="container" id="home-page">
      <div class="row " style="margin-top:50px;margin-bottom:50px;">
        <div class="col-md-12 col-sm-12 col-xs-12 category text-lower mb-20"> 
          <span class="cate-cont text-capi">Page Not Found</span>
        </div>
