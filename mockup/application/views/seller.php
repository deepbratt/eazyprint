...
#divEmailId2 .tooltip.top .tooltip-inner {
    ...
    <div class="formDivOuter formPadding gst-form">
       ...
       <div class="col-md-12 col-sm-12">
           <h2 class="register-now-label">WANT TO BUY FROM EAZYPRINT? </h2>
           <h5 class="register-now-label gst-label">Order your products in less than 10 minutes! </h5>
       </div>
	<form id="" name="j_id0:j_id30:j_id31:frmGST" method="post" action="" class="form frmGST" enctype="application/x-www-form-urlencoded">
            ...
            <div class="form-group">
                <div class="col-md-12 show-hd actv" id="fr-new-user">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 gst-label divMargin" id="divGSTN"><div class="group"><div class="tooltip top fade in" role="tooltip" style="bottom:34px"><div class="tooltip-arrow"></div><div class="tooltip-inner">GST Number is required</div></div><label class="sd-input">Enter your email</label><input id="j_id0:j_id30:j_id31:frmGST:sdGstn" type="text" name="j_id0:j_id30:j_id31:frmGST:sdGstn" class="form-control landing_input_text upper-case sd-input error-input" maxlength="15" onfocus="companySOSInfoClicks('Gst Number',this.id);" tabindex="10" autocomplete="new-password" required="required"><span class="bar"></span><span class="message" ng-pattern="sdInput.ngPattern" ng-show="sdInput.message" ng-bind-html="sdInput.message"></span></div>
                        ...
                        <div class="col-md-12 col-sm-12 marginBottom1 custom_inputrow custom_joinnow_btn" id="divRegisterNowBtn">
                            <div class="group">
                            <span class="loader_icon" id="join_now_loader_gst" style="top: 14px; z-index: 2; display: none;"> <img class="loader_img" src="/resource/1416511410000/loadingImageSmall"></span><input class="sf-button-primary" id="j_id0:j_id30:j_id31:frmGST:btnRegisterNow" name="j_id0:j_id30:j_id31:frmGST:btnRegisterNow" value="Register Now" tabindex="11" type="button">
                                </div>
                              
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <div class="professional-service">Need help in getting GST?<br> <a href="https://snapdeal-sf-prod.s3.amazonaws.com/docs/ProfessionalServices-V2.xlsx" target="_blank">Click Here</a> to download the list of professional service providers</div>
                        </div> 
                        <div class="">
                        </div>
                    </div>
