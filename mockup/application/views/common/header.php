							...
							<div class="row" style="height: 75px;margin-top: -3px;">
								...
								<div class="nav">
									  ...
									  <div class="sub-item" style="border:1px solid #CCCCCC;border-top:none;box-shadow: 0px 1px 1px 1px #CCCCCC;">
										<div class="row">
											...
											<div class="col-md-2 blk-mb" style="text-align:left;margin-top:5px;float:left;cursor:pointer !important;">
												<a href="<?php echo base_url('model_listing/');?><?php echo $each_mob_case->raw_id;?>"style="color:#009fdc;cursor:pointer !important;"> 
												<img src="admin/uploads/product_images/mug/<?php echo $each_mob_case->raw_image;?>">
									...
									<li class="nav-item with-sub  mega-dropdown">
									  <a class="nav-link" href="javascript:void(0);">
										<span class="d-none d-lg-block">
											<span class="text-dark"> T-SHIRTS </span>
										</span>
									  </a>
									  <div class="sub-item" style="border:1px solid #CCCCCC;border-top:none;box-shadow: 0px 1px 1px 1px #CCCCCC;">
										<div class="row">
