									  ...
									  <div class="sub-item" style="border:1px solid #CCCCCC;border-top:none;box-shadow: 0px 1px 1px 1px #CCCCCC;">
										<div class="row">
												...
												<div class="col-md-2" style="text-align:left;">
													<span style="color:#009fdc;"> Mugs </span>
													<ul style="padding-top:10px;">
													
														<li class="text-dark">Printed Mugs</li>
														<li class="text-dark">Corporate Mugs</li>
														<li class="text-dark">Couple Mugs</li>
														<li class="text-dark">Family Mugs</li>
