    ...
    <div class="col-md-12 col-lg-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title" style="width:100%;color:#5e5e5e;">Filters  <a href="#" style="float:right;text-align:right;color:#000;font-size:15px;"><b>Clear All</b></a></div>
        </div>
        <div class="card-body">
              ...
              <?php
				...
				$fetch_product_data = $ci->product_m->get_all_categories();
              	foreach($fetch_product_data AS $each_cat_data){
					$uri_pg = $this->uri->segment(2);
              ?>
              <option value="<?php echo $each_cat_data->cat_id;?>" <?php echo(($uri_pg == $each_cat_data->cat_id)?'selected':'');?>> <?php echo ucfirst($each_cat_data->category_name);?> </option>
              <?php
              	}
              ?>
            </select>
		  ...
		  <!--<div class="card-header" style="color:#5e5e5e;">
			<div class="card-title" style="width:100%;color:#5e5e5e;"> Size </div>
		  </div>
