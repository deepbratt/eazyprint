...
class Admin_add_product extends CI_Controller {
	...
	public function add_product()
	{
		...
		$material_type = $this->input->post('product_material_type');
		...
		if($this->input->post('dimension_len') != '' || $this->input->post('dimension_wid') != '' || $this->input->post('dimension_height') != '' || $this->input->post('product_dimension') != '')
		{
