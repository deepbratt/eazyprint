        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
            <div class="page-header">
              <h4 class="page-title">Edit Product
              </h4>
              <ol class="breadcrumb">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10"> 
                            ...
                            <input type="hidden" class="brandz_name" value="">
					            ...
					            <div class="form-group modelz" style="display:<?php echo (($fetch_product->product_category == '3')?'block':'none');?>;">
                        <div class="row">
                          <div class="col-md-2">
                          ...
                          <div class="col-md-10">
                              ...
                              <img src="<?php echo base_url();?>images/ajax-loader2.gif" id="AjaxLoader_3" style="float:left;margin-top:10px;margin-left:9px;position: absolute;z-index: 2;display: none;">
              								<input class="devname form-control" type="text" name="model" value="<?php echo $fetch_product->product_model_no;?>">
              							</div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
							  ...
							  ?>
								...
								<input type="file" name="p_image" id="my_file" style="display: none;" onchange="readURL(this);" />
							  <?php
							  }else{
							  ?>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="text" class="form-control" name="product_material_type" value="<?php echo $fetch_product->product_material_type;?>" placeholder="Product Metarial Type">
                          </div>
                        </div>
                      </div>
                         ...
                         <div class="row" style="margin-bottom:10px;">
                          ...
                          <div class="col-md-2" style="padding:0px;">
                            <a href="javascript:void(0);" onclick="add_another();" class="btn btn-primary">Add More</a>
            					...
            					<div class="form-group pro_sizez" style="display:<?php echo (($fetch_product->product_category == '3')?'none':'block');?>;">
                     <div class="row">
                      <div class="col-md-2">
                    ...
                    <div class="form-group pro_dimensionz" style="display:<?php echo (($fetch_product->product_category == '3')?'block':'none');?>;">
                      <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="dimension_len" value="<?php echo $fetch_product->product_dimension_length;?>" placeholder="Product length">
                        </div>
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="dimension_wid" value="<?php echo $fetch_product->product_dimension_width;?>" placeholder="Product Width">
                        </div>
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="dimension_height" value="<?php echo $fetch_product->product_dimension_height;?>" placeholder="Product height">
                        </div>
                        <div class="col-md-1">
                          <select name="product_dimension" class="form-control select2-show-search">
                            <option selected disabled>Choose</option>
							<option value="mm" <?php echo (($fetch_product->product_dimension_unit == 'mm')?'selected':'');?>>mm</option>
                            <option value="cm" <?php echo (($fetch_product->product_dimension_unit == 'cm')?'selected':'');?>>cm</option>
                          </select>
                        </div>
                      </div>
                    </div>

					          <div class="form-group p_shape" style="display:<?php echo (($fetch_product->product_category == '3')?'none':'block');?>;">
                        <div class="row">
                          <div class="col-md-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-1">
                             <select name="product_weight_dimension" class="form-control select2-show-search">
                                <option value="kg" <?php echo (($fetch_product->product_weight_unit == 'kg')?'selected':'');?>>kg</option>
                                <option value="gm" <?php echo (($fetch_product->product_weight_unit == 'gm')?'selected':'');?>>gm</option>
                             </select>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="quantity" class="form-control" placeholder="Add quantity" value="<?php echo $fetch_product->product_quantity;?>">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="number" name="min_order" class="form-control" placeholder="Add Minimum Order" value="<?php echo $fetch_product->min_order;?>">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
					  ...
					  <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="number" name="retail_price" class="form-control" placeholder="Add Retail Price" value="<?php echo $fetch_product->product_retail_price;?>">
                          </div>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="number" name="purchase_price" class="form-control" placeholder="Add Purchase Price" value="<?php echo $fetch_product->product_purchase_price;?>">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="text" name="meta_tags" data-role="tagsinput" class="form-control" placeholder="Add Tags" value="<?php echo $fetch_product->tags;?>">
                          </div>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <input type="text" name="meta_keyword" data-role="tagsinput" class="form-control" placeholder="Add Meta Keywords" value="<?php echo $fetch_product->meta_keywords;?>">
                          </div>
                        </div>
                      </div>
