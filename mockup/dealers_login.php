											   ...
											   <div class="row">
												...
												<div class="form-group">
													<label class="custom-control custom-checkbox">
														...
														<a href="dealers_forgot_password.php" class="float-right small">I forgot password</a>
													</label>
												</div>
												<div class="form-footer">
													<a href="dealers_dashboard.php" class="btn btn-primary">Login</a>&nbsp;OR&nbsp;
													<a href="dealers_signup.php" class="btn btn-primary">Sign Up Here</a>
												</div>
											</form>
										</div>
									</div>
