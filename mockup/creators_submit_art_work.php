...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Eazyprint | Submit Your Artwork</title>
					...
					<div class="side-app">
						...
						<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;margin:0px;">
							<div class="card">
								...
								<div class="card-body">
									<h1 class="text-center">Submit Your Artwork</h1>
								</div>
							</div>
						</div>
					</div>
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea rows="5" class="form-control" placeholder="Enter About your design description"></textarea>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<div class="form-label">Design For</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label for="exampleFormControlFile1">Upload Design</label>
