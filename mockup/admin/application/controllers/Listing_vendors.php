...
class Listing_vendors extends CI_Controller {

	public function index()
	{
		$this->load->model('contacts_m');
		$user_type = 'vendor';
		$data['fetch_vendor_data'] = $this->contacts_m->fetch_all_contacts_info($user_type);
 		$this->load->view('contacts/listing_vendors',$data);
	}
	...
	public function delete_dealer()
	{
		...
		if($delete_dealer){
			$this->session->set_flashdata("success", "Success , Your have successfully deleted this vendor!");
			redirect('listing_vendors');
		}
		else{
