...
class Add_tshirt extends CI_Controller {
	...
	{
		$this->load->view('products/add_tshirt');
	}

	public function add_pro_tshirt()
		{ 
		...
		if(!empty($_FILES['p_image']['name'])){
			$config['upload_path'] = 'uploads/product_images/t_shirt/';
		...
		if(!empty($_FILES['meta_image']['name'])){
			...
			$update_tshirt = $this->add_tshirt_m->update_pro_tshirt($records);
