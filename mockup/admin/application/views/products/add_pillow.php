...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Title -->
    <title>Eazyprint | Add Pillow</title>
        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
            <div class="page-header">
              <h4 class="page-title">Add Pillow &nbsp;&nbsp;<a href="<?php echo base_url("listing_pillows");?>" class="btn btn-primary">View All</a></h4>
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="#">Eazycrew
                  </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Add Pillow </li>
              </ol>
            </div>
      		<?php
			...
			?>
            <form name="add_pillow" method="post" enctype="multipart/form-data" action="<?php echo base_url('add_pillow/add_pro_pillow');?>">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="category" value="Pillows" readonly>
								</div>
							</div>
						</div>
					</div>
