      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
			...
			?>
            <form name="add_mobile_case" method="post" enctype="multipart/form-data" action="<?php echo base_url('edit_mobile_case/update_mobile_case/');?><?php echo $this->uri->segment(2);?>">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
