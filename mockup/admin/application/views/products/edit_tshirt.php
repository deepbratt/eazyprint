...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Title -->
    <title>Eazyprint | Edit T-Shirt</title>
        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
            <div class="page-header">
              <h4 class="page-title">Edit T-Shirt &nbsp;&nbsp;<a href="<?php echo base_url("listing_tshirt");?>" class="btn btn-primary">View All</a></h4>
              <ol class="breadcrumb">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="brand" value="<?php echo $fetch_tshirt->raw_brand;?>" placeholder="Type a brand">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="product_name" value="<?php echo $fetch_tshirt->raw_name;?>" placeholder="Product Name">
							  </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Product Title</label>
									<input type="text" class="form-control" name="product_title" value="<?php echo $fetch_tshirt->raw_title;?>" placeholder="Product Title">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label class="form-label">Product Description</label>
									<textarea class="form-control" name="product_desc" placeholder="Enter Product Description"><?php echo $fetch_tshirt->raw_desc;?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="product_material_type" value="<?php echo $fetch_tshirt->raw_material_type;?>" placeholder="Product Metarial Type">
							  </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Product Size</label>
									<input type="text" class="form-control" name="product_size" value="<?php echo $fetch_tshirt->raw_size;?>" placeholder="New Product Size">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="dimension_len" value="<?php echo $fetch_tshirt->raw_dimension_length;?>" placeholder="Product length">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label class="form-label">Dimension Unit</label>
									<select name="product_dimension_unit" value="<?php echo $fetch_tshirt->raw_dimension_unit;?>" class="form-control select2-show-search">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="product_shape" value="<?php echo $fetch_tshirt->raw_shapetype;?>" placeholder="Product Shape">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="form-label">Product Weight</label>
									<input type="text" name="product_weight" class="form-control" value="<?php echo $fetch_tshirt->raw_weight;?>" placeholder="Add Product Weight">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="form-label">Weighing Unit</label>
									<select name="product_weight_unit" value="<?php echo $fetch_tshirt->raw_weight_unit;?>" class="form-control select2-show-search">
	                         	...
	                         	<div class="row">
		                          ...
		                          <div class="col-md-6">
		                          	<div class="form-group">
									   ...
									   <?php
										$explode_color = explode(',',$fetch_tshirt->raw_color);
		                          ...
		                          <div class="col-md-2" style="margin-top:1.5rem;">
										...
										<?php
										$explode_color_code = explode(',',$fetch_tshirt->raw_color_code);
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" name="product_quantity" class="form-control" value="<?php echo $fetch_tshirt->raw_quantity;?>" placeholder="Add quantity">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Minimum Order</label>
									<input type="number" name="min_order" class="form-control" value="<?php echo $fetch_tshirt->min_order;?>" placeholder="Add Minimum Order">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" name="wholesale_price" class="form-control" value="<?php echo $fetch_tshirt->raw_wholesale_price;?>" placeholder="Add Wholesale Price">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="form-label">Retail Price</label>
									<input type="number" name="retail_price" class="form-control" value="<?php echo $fetch_tshirt->raw_retail_price;?>" placeholder="Add Retail Price">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="form-label">Purchase Price</label>
									<input type="number" name="purchase_price" class="form-control" value="<?php echo $fetch_tshirt->raw_purchase_price;?>" placeholder="Add Purchase Price">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="meta_tags[]" data-role="tagsinput" value="<?php echo $fetch_tshirt->raw_tags;?>" class="form-control" placeholder="Add Tags">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Meta Keywords</label>
									<input type="text" name="meta_keyword[]" data-role="tagsinput" value="<?php echo $fetch_tshirt->raw_meta_keywords;?>" class="form-control" placeholder="Add Meta Keywords">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label class="form-label">Meta Description</label>
									<textarea class="form-control" name="meta_desc" placeholder="Enter Meta Description"><?php echo $fetch_tshirt->raw_meta_desc;?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="hsn_code" class="form-control" value="<?php echo $fetch_tshirt->raw_hsn_code;?>" placeholder="Add HS Code">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">GST Rate(%)</label>
									<input type="text" name="gst_rate" class="form-control" value="<?php echo $fetch_tshirt->raw_gst_rate;?>" placeholder="Add GST Rate">
								</div>
							</div>
						</div>
					</div>
