...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Title -->
    <title>Eazyprint | Edit Pillow</title>
        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
            <div class="page-header">
              <h4 class="page-title">Edit Pillow &nbsp;&nbsp;<a href="<?php echo base_url("listing_pillows");?>" class="btn btn-primary">View All</a></h4>
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="#">Eazycrew
                  </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Edit Pillow </li>
              </ol>
            </div>
			<?php
			...
			?>
            <form  method="post" enctype="multipart/form-data" action="<?php echo base_url('edit_pillow/update_pro_pillow/');?>">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="product_name" value="<?php echo $fetch_pillow->raw_name;?>" placeholder="Product Name">
							  </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Product Title</label>
									<input type="text" class="form-control" name="product_title" value="<?php echo $fetch_pillow->raw_title;?>" placeholder="Product Title">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label class="form-label">Product Description</label>
									<textarea class="form-control" name="product_desc" placeholder="Enter Product Description"><?php echo $fetch_pillow->raw_desc;?></textarea>
							...
							<div class="col-md-2">
							  ...
							  <div class="col-md-10">
								...
								?>
									...
									<img src="<?php echo base_url('uploads/product_images/mug/');?><?php echo $fetch_pillow->raw_image;?>" onclick="product_image()" style="height:150px;" id="p_blah">
								<?php
								}
								?>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="product_material_type" value="<?php echo $fetch_pillow->raw_material_type;?>" placeholder="Product Metarial Type">
							  </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Product Shape</label>
									<input type="text" class="form-control" name="product_shape" value="<?php echo $fetch_pillow->raw_shapetype;?>" placeholder="Product Shape">
								</div>
							</div>
						</div>
						<div class="row">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="dimension_len" value="<?php echo $fetch_pillow->raw_dimension_length;?>" placeholder="Product length">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label class="form-label">Product Height</label>
									<input type="text" class="form-control" name="dimension_height" value="<?php echo $fetch_pillow->raw_dimension_height;?>" placeholder="Product Height">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label class="form-label">Product width</label>
									<input type="text" class="form-control" name="dimension_width" value="<?php echo $fetch_pillow->raw_dimension_width;?>" placeholder="Product Width">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<select name="product_dimension_unit"  class="form-control select2-show-search">
										<option value="mm" <?php echo (($fetch_pillow->raw_dimension_unit == 'mm')?'selected':'');?>>mm</option>
										<option value="cm" <?php echo (($fetch_pillow->raw_dimension_unit == 'cm')?'selected':'');?>>cm</option>
									</select>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="product_weight" class="form-control" value="<?php echo $fetch_pillow->raw_weight;?>" placeholder="Add Product Weight">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="product_weight_unit"  class="form-control select2-show-search">
										<option value="kg" <?php echo (($fetch_pillow->raw_weight_unit == 'kg')?'selected':'')?>>kg</option>
										<option value="gm" <?php echo (($fetch_pillow->raw_weight_unit == 'gm')?'selected':'')?>>gm</option>
									 </select>
								</div>
							</div>
	                         	...
	                         	<div class="row">
		                          ...
		                          <div class="col-md-6">
		                          	<div class="form-group">
									   ...
									   <?php
										$explode_color = explode(',',$fetch_pillow->raw_color);
		                          ...
		                          <div class="col-md-2" style="margin-top:1.5rem;">
										...
										<?php
										$explode_color_code = explode(',',$fetch_pillow->raw_color_code);
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" name="product_quantity" class="form-control" value="<?php echo $fetch_pillow->raw_quantity;?>" placeholder="Add quantity">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Minimum Order</label>
									<input type="number" name="min_order" class="form-control" value="<?php echo $fetch_pillow->min_order;?>" placeholder="Add Minimum Order">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" name="wholesale_price" class="form-control" value="<?php echo $fetch_pillow->raw_wholesale_price;?>" placeholder="Add Wholesale Price">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="form-label">Retail Price</label>
									<input type="number" name="retail_price" class="form-control" value="<?php echo $fetch_pillow->raw_retail_price;?>" placeholder="Add Retail Price">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="form-label">Purchase Price</label>
									<input type="number" name="purchase_price" class="form-control" value="<?php echo $fetch_pillow->raw_purchase_price;?>" placeholder="Add Purchase Price">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="row" style="margin-top:15px;">
						  ...
						  ?>
							<input type="file" name="meta_image" id="my_file"  class="form-control hide_file" style="display:none;"  placeholder="Add Meta Image" onchange="readURL(this);">
						    <img src="<?php echo base_url('uploads/meta_images/');?><?php echo $fetch_pillow->raw_meta_img;?>" onclick="meta_img()" style="height:150px;" id="blah">
						  <?php
						  }
						  ?>
						  </div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="meta_tags[]" data-role="tagsinput" value="<?php echo $fetch_pillow->raw_tags;?>" class="form-control" placeholder="Add Tags">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Meta Keywords</label>
									<input type="text" name="meta_keyword[]" data-role="tagsinput" value="<?php echo $fetch_pillow->raw_meta_keywords;?>" class="form-control" placeholder="Add Meta Keywords">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label class="form-label">Meta Description</label>
									<textarea class="form-control" name="meta_desc" placeholder="Enter Meta Description"><?php echo $fetch_pillow->raw_meta_desc;?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="hsn_code" class="form-control" value="<?php echo $fetch_pillow->raw_hsn_code;?>" placeholder="Add HS Code">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">GST Rate(%)</label>
									<input type="text" name="gst_rate" class="form-control" value="<?php echo $fetch_pillow->raw_gst_rate;?>" placeholder="Add GST Rate">
								</div>
							</div>
						</div>
					</div>
