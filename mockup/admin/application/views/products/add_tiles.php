...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- Title -->
    <title>Eazyprint | Add Tiles</title>
        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
            <div class="page-header">
              <h4 class="page-title">Add Tiles &nbsp;&nbsp;<a href="<?php echo base_url("listing_tiles");?>" class="btn btn-primary">View All</a></h4>
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="#">Eazycrew
                  </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Add Tiles </li>
              </ol>
            </div>
      		<?php
			...
			?>
            <form name="add_tiles" method="post" enctype="multipart/form-data" action="<?php echo base_url('add_tiles/add_pro_tiles');?>">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
