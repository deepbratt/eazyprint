        ...
        <div class="my-3 my-md-5 app-content">
          <div class="side-app">
            <div class="page-header">
              <h4 class="page-title">Add Mug &nbsp;&nbsp;<a href="<?php echo base_url("listing_mug");?>" class="btn btn-primary">View All</a></h4>
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="#">Eazycrew
                  </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Add Mug </li>
              </ol>
            </div>
      		<?php
			...
			?>
            <form name="add_mug" method="post" enctype="multipart/form-data" action="<?php echo base_url('add_mug/add_pro_mug');?>">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
