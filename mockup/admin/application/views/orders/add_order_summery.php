              ...
              <div class="row">
                <div class="col-lg-12">
                  <div id="show_all_info" >
                    ...
                    <div class="col-md-12 "> 
                      <div class="card card-aside" style="padding:15px;;"> 
					  <div class="col-md-8">
					  <div class="col-md-2">
                        <a href="#" class="" style="">
							<img src="<?php echo base_url('uploads/product_images/mobile_case');?>/<?php echo $fetch_order_product->raw_image;?>" style="margin-top:15px;">
                        </a> 
						</div>
                        <div class="card-body d-flex flex-column"> 
                          <h4>
                            <a href="#"><?php echo $fetch_order_product->raw_name;?>.
                            </a>
                          </h4> 
                          <div class="text-muted"><?php echo $fetch_order_product->raw_desc;?>
                          </div> 
						   <div class="text-muted">Price = <?php echo $fetch_order_product->raw_retail_price;?>* 1
                          </div>
						    <div class="text-muted">Discount Amount = 
                          </div>
						   <div class="text-muted">Sub Total = 
                          </div>
                         </div>
                        </div> 
                        <div class="col-md-4"> 
							<div class="dash-box dash-box-color-1"> 
								<div class="dash-box-icon"> <i class="fas fa-piggy-bank fa-2x"></i> </div> 
								<div class="dash-box-body"> <div class="h3 m-0 text-white"> <b>&#8377; 2056</b> </div><span class="dash-box-title">Amount To Be Paid</span> </div> 
								<div class="dash-box-action"></div> 
							</div>
						</div> 
                            ...
                            <div class="row" id="ml_image" style="margin-top:15px;">
                              <div class="col-md-12">
                                <label class="form-label">Upload Image
                                  <br>
                                  <span style="font-size:12px;">(For multiple images press ctrl.)
                                  </span>
                                </label>
                              </div>
                              <div class="col-md-6">
                                <span onclick="product_image();" id="hide_span" class="btn btn-icon btn-primary file_upload_icon" style="margin-top:6px;">
                                  ...
                                  <strong style="color:#000000;padding:10px;font-size:15px;">Choose File...
                                  </strong>
                                </span>
