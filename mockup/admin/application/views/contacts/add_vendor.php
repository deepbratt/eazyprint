				...
				<div class="my-3 my-md-5 app-content">
					<div class="side-app">
						<div class="page-header">
							<h4 class="page-title">Add Vendor &nbsp;&nbsp;<a href="<?php echo base_url("listing_vendors");?>" class="btn btn-primary">View All</a></h4>
							<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-md-12">
								<form  method="post" name="add_vendor" action="<?php echo base_url('add_vendor/add_new_vendor');?>">
								<div class="card">
