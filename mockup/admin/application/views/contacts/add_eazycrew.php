...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>Eazyprint | Add Eazycrew</title>
		<style>
		.error{
			color : red;
			font-weight: 450;
				...
				<div class="my-3 my-md-5 app-content">
					<div class="side-app">
						<div class="page-header">
							<h4 class="page-title">Add Eazycrew &nbsp;&nbsp;<a href="<?php echo base_url("listing_eazycrew");?>" class="btn btn-primary">View All</a></h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Eazycrew</a></li>
								<li class="breadcrumb-item active" aria-current="page">Add Eazycrew</li>
							</ol>
						</div>
						<?php
						...
						<div class="row">
							<div class="col-md-12">
								<form  method="post" name="add_eazycrew" action="<?php echo base_url('add_eazycrew/add_new_crew');?>">
								<div class="card">
