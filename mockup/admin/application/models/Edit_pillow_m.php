...
class Edit_pillow_m extends CI_Model {

	public function fetch_pro_pillow($raw_id){
		$this->db->select('*');
	...
	public function update_pilow($raw_id,$records,$pre_img,$image_status,$pre_meta,$meta_status)
	{
