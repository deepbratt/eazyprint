    ...
    <div class="container">
      <div class="side-app">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
          <div class="example">
            <div class="btn-list">
              <a href="#" class="btn btn-pill btn-success">Submit Your Artwork
              </a>
              <a href="#" class="btn btn-pill btn-info">Create Your Own Artwork
              </a>
            </div>
          </div>
        </div>
