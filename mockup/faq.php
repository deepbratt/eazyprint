	...
	<body class="app">
		...
		<div class="page">
			<div class="page-main">
					...
					<div class="container">
						<ul class="nav">
							...
							<li class="nav-item with-sub mega-dropdown">
								<a class="nav-link active" href="#"><i class="fas fa-pen-square"></i><span>UI ELEMENTS</span></a>
								<div class="sub-item">
									<div class="row">
										<div class="col-lg-6">
				...
				<!-- Horizantal menu-->
				<div class="about-img pt-7">
					<div class="card-body p-8 align-items-center text-center">
						<h2 class="text-white display-5 font-weight-semibold">FAQ</h2>
